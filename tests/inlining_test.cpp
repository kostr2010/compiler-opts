...
TEST(TestInlining, Example0)
{
    ...
    */
    ...
    auto P0 = p0->GetId();
    ASSERT_EQ(p0->GetOpcode(), Opcode::PARAM);
    ...
    auto I0 = i0->GetId();
    ASSERT_EQ(i0->GetOpcode(), Opcode::RETURN);
...
TEST(TestInlining, Example1)
{
    ...
    */
    ...
    auto c1 = c0->GetNext();
    auto C1 = c1->GetId();
    ASSERT_EQ(c1->GetOpcode(), Opcode::CONST);
    ASSERT_NE(c1->GetNext(), nullptr);
    auto c2 = c1->GetNext();
    auto C2 = c2->GetId();
    ASSERT_EQ(c2->GetOpcode(), Opcode::CONST);
    ...
    auto i0 = a->GetFirstInst();
    auto I0 = i0->GetId();
    ASSERT_EQ(i0->GetOpcode(), Opcode::IF);
    ASSERT_EQ(i0->GetNext(), nullptr);
    ...
    auto I1 = i1->GetId();
    ASSERT_EQ(i1->GetOpcode(), Opcode::MUL);
    ...
    auto I2 = i2->GetId();
    ASSERT_EQ(i2->GetOpcode(), Opcode::ADD);
    ...
    auto I3 = i3->GetId();
    ASSERT_EQ(i3->GetOpcode(), Opcode::PHI);
    ...
    auto I4 = i4->GetId();
    ASSERT_EQ(i4->GetOpcode(), Opcode::RETURN);
...
TEST(TestInlining, Example2)
{
    ...
    */
    ...
    auto i0 = a->GetFirstInst();
    auto I0 = i0->GetId();
    ASSERT_EQ(i0->GetOpcode(), Opcode::MUL);
    ASSERT_EQ(i0->GetNext(), nullptr);
    ASSERT_EQ(I0, a->GetLastInst()->GetId());
    ...
    auto i3 = i2->GetNext();
    auto I3 = i3->GetId();
    ASSERT_EQ(i3->GetOpcode(), Opcode::IF);
    ASSERT_EQ(i3->GetNext(), nullptr);
...
TEST(TestInlining, Example3)
{
    ...
    */
    ...
    auto i1 = i0->GetNext();
    auto I1 = i1->GetId();
    ASSERT_EQ(i1->GetOpcode(), Opcode::IF);
    ASSERT_EQ(i1->GetNext(), nullptr);
    ...
    auto I3 = i3->GetId();
    ASSERT_EQ(i3->GetOpcode(), Opcode::SUB);
    ASSERT_EQ(i3->GetNext(), nullptr);
    ASSERT_EQ(I3, c->GetLastInst()->GetId());
    ASSERT_EQ(c->GetSuccessors().size(), 1);
    ...
    auto I4 = i4->GetId();
    ASSERT_EQ(i4->GetOpcode(), Opcode::PHI);
    ASSERT_EQ(i4->GetNext(), nullptr);
    ...
    auto I5 = i5->GetId();
    ASSERT_EQ(i5->GetOpcode(), Opcode::RETURN);
