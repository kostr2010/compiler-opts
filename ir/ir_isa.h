#define INSTRUCTION_LIST(_)                                                                       \
    _(ADD, BinaryOp, InstFlags::EMPTY)                                                            \
    _(SUB, BinaryOp, InstFlags::EMPTY)                                                            \
    _(MUL, BinaryOp, InstFlags::EMPTY)                                                            \
    _(DIV, BinaryOp, InstFlags::EMPTY)                                                            \
    _(MOD, BinaryOp, InstFlags::EMPTY)                                                            \
    _(MIN, BinaryOp, InstFlags::EMPTY)                                                            \
    _(MAX, BinaryOp, InstFlags::EMPTY)                                                            \
    _(SHL, BinaryOp, InstFlags::EMPTY)                                                            \
    _(SHR, BinaryOp, InstFlags::EMPTY)                                                            \
    _(ASHR, BinaryOp, InstFlags::EMPTY)                                                           \
    _(AND, BinaryOp, InstFlags::EMPTY)                                                            \
    _(OR, BinaryOp, InstFlags::EMPTY)                                                             \
    _(XOR, BinaryOp, InstFlags::EMPTY)                                                            \
