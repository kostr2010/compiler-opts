...
#define CHAIN_COMMA_0(ELEM) ELEM CHAIN_COMMA_1
#define CHAIN_COMMA_1(ELEM) DEFER(COMMA)() ELEM CHAIN_COMMA_2
#define CHAIN_COMMA_2(ELEM) DEFER(COMMA)() ELEM CHAIN_COMMA_1
...
#define CHAIN_SEPARATOR_0(ELEM) ELEM CHAIN_SEPARATOR_1
#define CHAIN_SEPARATOR_1(ELEM) DEFER(SEPARATOR)() ELEM CHAIN_SEPARATOR_2
#define CHAIN_SEPARATOR_2(ELEM) DEFER(SEPARATOR)() ELEM CHAIN_SEPARATOR_1
